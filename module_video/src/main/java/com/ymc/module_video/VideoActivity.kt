...
import kotlinx.android.synthetic.main.video_activity_video.*

@Route(path = ARouterConstant.VIDEO_ACTIVITY)
class VideoActivity : IJKBaseActivityDetail<StandardIJKVideoPlayer>() {
